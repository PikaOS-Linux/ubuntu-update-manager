...
__metaclass__ = type
__all__ = ["ManualInstallCruft", "MarkLangpacksManuallyInstalledPlugin"]
...
class ManualInstallCruft(Cruft):
    ...
    def get_description(self):
        return (
            _("%s needs to be marked as manually installed.") % self.pkg.name
        )
...
class MarkLangpacksManuallyInstalledPlugin(Plugin):
    ...
    def get_cruft(self):
        ...
        for pkg in cache:
            if (
                pkg.name.startswith("language-pack-")
