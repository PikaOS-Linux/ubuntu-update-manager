...
class ManagerTests(unittest.TestCase):
    ...
    def test_plugin_loading_callback_with_multiple_plugins(self):
        ...
        self.assertEqual(
            callback_calls,
            [("alpha_plugin.py", 0, 2), ("bravo_plugin.py", 1, 2)],
        )
    ...
    def test_condition_equality(self):
        ...
        self.assertEqual(
            manager.get_plugins(condition="alpha"), [all_plugins[0]]
        )
        self.assertEqual(
            manager.get_plugins(condition="bravo"), [all_plugins[1]]
        )
    ...
    def test_condition_in(self):
        ...
        self.assertEqual(
            manager.get_plugins(condition="sad"), [all_plugins[1]]
        )
